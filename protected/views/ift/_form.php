	...
	<?php $form=$this->beginWidget('booster.widgets.TbActiveForm', array(
		...
		<fieldset>
			...
			<div class="row">
				...
				$data = array('GWI','IAEW','Fraunhofer UMSICHT','Gelsenwasser');
		...
		<div class="row">
			...
			$criteria->condition="user_type_ID='2' AND role_ID='3'";
		...
		<div class="row">
			...
			$criteria = new CDbCriteria;
			$criteria->select='user_ID,username';
			$criteria->condition="user_type_ID='2' AND role_ID != '5' AND role_ID != '6' ";
