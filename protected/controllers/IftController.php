...
public function actionView($id)
{
	...
	if($type_ID == "2" || $type_ID=="3" || $role_ID  ="2" || $role_ID = "5"){
...
public function actionCreate()
{
	...
	$type_ID = $user->user_type_ID;
		...
		*/
		if($user_right_ID == "2" && ($type_ID=="2" || $type_ID=="3")){
			if(isset($_POST['Ift']))
			{
				$model->attributes=$_POST['Ift'];
				$m_thematische = "";
...
public function actionIndex()
{
	...
	*/
	...
	if($type_ID == "2" || $type_ID=="3" || $role_ID  ="2" || $role_ID = "5" || $role_ID = "6"){		
		$dataProvider=new CActiveDataProvider('Ift');
...
public function actionAdmin()
{
	...
	*/
	if($type_ID == "2" || $type_ID=="3" || $role_ID  ="2" || $role_ID = "5"){
		$model=new Ift('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ift']))
			$model->attributes=$_GET['Ift'];			
 ...
 * @return Ift the loaded model
 * @throws CHttpException
 */
public function loadModel($id)
{
	$model=Ift::model()->findByPk($id);
	if($model===null)
 ...
 * @param Ift $model the model to be validated
 */
protected function performAjaxValidation($model)
{
	if(isset($_POST['ajax']) && $_POST['ajax']==='ift-form')
	{
