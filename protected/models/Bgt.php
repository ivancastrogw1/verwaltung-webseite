...
/**
 * This is the model class for table "{{bgt}}".
 *
 * The followings are the available columns in table '{{bgt}}':
 ...
 */
class Bgt extends CActiveRecord
{
	/**
	 ...
	 * @return Bgt the static model class
	 */
